...
async function clickMerge(files,val, example){
    ...
    window.open('https://kohlbacherlab.github.io/BioGraphVisart/merge?leftID='+leftID+'&rightID='+rightID +'&file1='+objectURL1+'&file2='+objectURL2+'&nodeVal='+val+'&example='+example);
}
