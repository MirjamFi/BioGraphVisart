const layoutArray = ["cose-bilkent", "klay", "dagre", "breadthfirst",  "grid"];
...
const compstyle = {selector: 'edge[interaction = \'compound\'], edge[interaction = \'proteincomplexformation\']',
          style: {
...
const molinteractstyle = {selector: 'edge[interaction = \'molecular interaction\'], edge[interaction = \'molecularinteraction\']',
          style: {
            'target-arrow-shape': 'circle',
            'line-style': 'solid'
        }}
